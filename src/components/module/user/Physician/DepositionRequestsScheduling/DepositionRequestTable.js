...
import DownloadTranscriptFile from '../../lawfirm/Modal/DownloadTranscriptFile';
                                  ...
                                  <li className="!p-0 focus:!bg-transparent active:!bg-transparent">
                                    <div className="items-center !p-0">
                                      ...
                                      {!([0, 3].includes(item?.depo_status)) && (
                                        ...
                                        >
                                          <Link
                                            // href={`/Physician/depositionrequests/chat/${item?.id}`} 
                                            href={`${data?.user?.role_id === "8" ? "/Expert" : "/Physician"}/depositionrequests/chat/${item?.id}`}
                                            className="w-9 overflow-hidden flex items-center justify-center p-2 flex-[0_0_0.5625rem]">
                                            <Image
                                              src={ChatIcon}
                                              alt="Chat icon"
