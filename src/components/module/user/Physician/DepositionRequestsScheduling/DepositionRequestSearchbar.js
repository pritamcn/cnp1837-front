...
const DepositionRequestSearchbar = ({ handleSearchvalue }) => {
                ...
                {search ? (
                    <>
                        ...
                        <input
                            ...
                            id="search-form"
                            className="form-control"
                            placeholder="Search by deponent id"
                                        ...
                                        {statusvalue === 5
                                            ...
                                            : statusvalue === 1
                                                ...
                                                : statusvalue === 2 ? 'Pending' :
                                                    statusvalue === 3 ? 'Reschedule request' :
                                                        statusvalue === 0 ? 'Rejected' : 'Waiting for payment'}
                                    </span>
...
export default DepositionRequestSearchbar;
