...
const CancellationRefundSearch = ({ searchHandler }) => {
                ...
                {search ? (
                    <>
                        <div className='w-full'>
                            <input type="text" placeholder='Deponent name' id='search-form' className='form-control' value={searchValue} onChange={(e) => setSearchValue(e.target.value)} />
                        </div>
...
export default CancellationRefundSearch;