...
const UserManagementSearch = ({ searchHandler }) => {
    ...
    return (
        <div className='flex gap-4 items-center'>
            ...
            <div className='w-full'>
                <input type="text" placeholder='Email' id='search-form' className='form-control' value={searchValue} onChange={(e) => setSearchValue(e.target.value)} />
            </div>
